...
public class MovieShow {
	...
	// 10-11
	 public Integer getShowTimeId() {
	        return embeddedId.getShowTimeId();  // Accessing showTimeId through the embedded ID
	    }

	    public void setShowTimeId(Integer showTimeId) {
	        embeddedId.setShowTimeId(showTimeId);  // Setting showTimeId through the embedded ID
	    }
	
	public String getMovieId() {
		return embeddedId.getMovieId();
	}
	public void getMovieId(String movieId) {
